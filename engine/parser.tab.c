...
int yyparse (node <double> *(&root), params list, variables &vmap, var_stack <double> &vst, func_stack <double> &fst);
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (root, list, vmap, vst, fst, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Type, Value, root, list, vmap, vst, fst); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, node <double> *(&root), params list, variables &vmap, var_stack <double> &vst, func_stack <double> &fst)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (root);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, node <double> *(&root), params list, variables &vmap, var_stack <double> &vst, func_stack <double> &fst)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, root, list, vmap, vst, fst);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, node <double> *(&root), params list, variables &vmap, var_stack <double> &vst, func_stack <double> &fst)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, root, list, vmap, vst, fst); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, node <double> *(&root), params list, variables &vmap, var_stack <double> &vst, func_stack <double> &fst)
{
  YYUSE (yyvaluep);
  YYUSE (root);
  YYUSE (list);
...
int
yyparse (node <double> *(&root), params list, variables &vmap, var_stack <double> &vst, func_stack <double> &fst)
{
    int yystate;
...
#line 112 "parser.y" /* yacc.c:1646  */
    { // Exponentiation
		(yyval.expr) = new node <double> (&def ::exp_op, {(yyvsp[-2].expr), (yyvsp[0].expr)});
}
...
#line 116 "parser.y" /* yacc.c:1646  */
    { // Multiplication
		(yyval.expr) = new node <double> (&def ::mult_op, {(yyvsp[-2].expr), (yyvsp[0].expr)});
}
...
#line 120 "parser.y" /* yacc.c:1646  */
    { // Division
		(yyval.expr) = new node <double> (&def ::div_op, {(yyvsp[-2].expr), (yyvsp[0].expr)});
}
...
#line 124 "parser.y" /* yacc.c:1646  */
    { // Addition
		(yyval.expr) = new node <double> (&def ::add_op, {(yyvsp[-2].expr), (yyvsp[0].expr)});
}
...
#line 128 "parser.y" /* yacc.c:1646  */
    { // Subtraction
		(yyval.expr) = new node <double> (&def ::sub_op, {(yyvsp[-2].expr), (yyvsp[0].expr)});
}
...
#line 132 "parser.y" /* yacc.c:1646  */
    {
		(yyval.expr) = new node <double> (&def ::sub_op, {
			new node <double> (new opd(-1), {}), (yyvsp[0].coll)
		});
}
...
#line 143 "parser.y" /* yacc.c:1646  */
    { // Implicit Multiplication: term and non-arithmetic operation
		...
		(yyval.coll) = new node <double> (&def ::mult_op, l_none, leaves);
}
...
#line 168 "parser.y" /* yacc.c:1646  */
    { // Implicit Multiplication: two or more terms
		...
		(yyval.term) = new node <double> (&def ::mult_op, l_none, leaves);
}
...
#line 183 "parser.y" /* yacc.c:1646  */
    {
		...
		(yyval.felm) = new node <double> {&def ::log_op,
			l_none, leaves};
}
...
#line 259 "parser.y" /* yacc.c:1646  */
    { // Cot
		...
		(yyval.felm) = new node <double> {&def ::cot_op,
			l_none, leaves};
}
...
#line 271 "parser.y" /* yacc.c:1646  */
    { // Sec
		...
		(yyval.felm) = new node <double> {&def ::sec_op,
			l_none, leaves};
}
...
#line 283 "parser.y" /* yacc.c:1646  */
    { // Csc
		...
		(yyval.felm) = new node <double> {&def ::csc_op,
			l_none, leaves};
}
...
#line 295 "parser.y" /* yacc.c:1646  */
    { // Tan
		...
		(yyval.felm) = new node <double> {&def ::tan_op,
			l_none, leaves};
}
...
#line 307 "parser.y" /* yacc.c:1646  */
    { // Cos
		...
		(yyval.felm) = new node <double> {&def ::cos_op,
			l_none, leaves};
}
...
#line 319 "parser.y" /* yacc.c:1646  */
    { // Sin
		...
		(yyval.felm) = new node <double> {&def ::sin_op,
			l_none, leaves};
}
...
#line 332 "parser.y" /* yacc.c:1646  */
    {
		...
		(yyval.dopn) = new node <double> {&def ::exp_op,
			l_none, leaves};
}
...
#line 360 "parser.y" /* yacc.c:1646  */
    { // Variable
		...
		(yyval.dpnt) = new node <double> {&def ::mult_op,
		...
		for (int i = 0; i < str.length(); i++) {
			...
			if (var != list.end()) {
				...
				(yyval.dpnt) = new node <double> {&def ::mult_op, l_none,
					{(yyval.dpnt), new node <double> {new variable <double> {var->symbol(), true}, l_none, {}}}};
				vmap[var->symbol()].push_back((yyval.dpnt)->child_at(1));
				// temp = $$;
				acc.clear();
				num++;
			}
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (root, list, vmap, vst, fst, YY_("syntax error"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (root, list, vmap, vst, fst, yymsgp);
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, root, list, vmap, vst, fst);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, root, list, vmap, vst, fst);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (root, list, vmap, vst, fst, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, root, list, vmap, vst, fst);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
